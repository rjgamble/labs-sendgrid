...
public record Template(string Name, string Subject, string Content, object SampleData);

public static class Templates
{
    public static Template Simple = new(
        "simple",
        "Hi there, {{user.name}}",
        @"
        <p>Dear {{user.name}}, thank you for your order</p>",
        new { user = new { name = "Alice Smith"} });

    public static Template Invoice = new Template(
        "invoice",
        "Here's your order, {{user.name}}",
        @"<!DOCTYPE html>
<html
                                  ...
                                  <tr>
                                    ...
                                    >
                                      <img
                                        align=""center""
                                        border=""0""
                                        src=""https://cdn.templates.unlayer.com/assets/1594973549343-logo.png""
                                        alt=""Image""
                                        title=""Image""
                                        style=""
                                          outline: none;
                                    ...
                                    <strong
                                      ><span
                                        style=""
                                          ...
                                          line-height: 19.6px;
                                        ""
                                        >{{order.currency}}{{order.grandTotal}}</span
                                      ></strong
                                    >
                                  </p>
                                </div>
                                      ...
                                      ><strong
                                        ><span
                                          style=""
                                            ...
                                            font-size: 24px;
                                          ""
                                          >Get 20% OFF on your next order</span
                                        ></strong
                                      ></span
                                    >
                                  </p>
                            ...
                            <tr>
                              ...
                              >
                                <div class=""v-text-align"" align=""center"">
                                  <!--[if mso]><table width=""100%"" cellpadding=""0"" cellspacing=""0"" border=""0"" style=""border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Open Sans',sans-serif;""><tr><td class=""v-text-align"" style=""font-family:'Open Sans',sans-serif;"" align=""center""><v:roundrect xmlns:v=""urn:schemas-microsoft-com:vml"" xmlns:w=""urn:schemas-microsoft-com:office:word"" href="""" style=""height:46px; v-text-anchor:middle; width:152px;"" arcsize=""87%"" stroke=""f"" fillcolor=""#ffffff""><w:anchorlock/><center style=""color:#3598db;font-family:'Open Sans',sans-serif;""><![endif]-->
                                  <a
                                    href=""""
                                    target=""_blank""
                                    style=""
